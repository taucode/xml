...
namespace TauCode.Xml
{
    ...
    {
        private IXmlDataNode Deserialize(Type elementType, XmlElement xmlElement)
        {
        ...
        public TElementXmlDataNode Deserialize<TElementXmlDataNode>(XmlElement xmlElement)
            where TElementXmlDataNode : ElementXmlDataNode
        {
        ...
        private PropertyInfo TryGetAttributePropertyInfo(Type elementType, string xmlAttributeName)
        {
            ...
            {
                var attr = prop.GetCustomAttribute<XmlDataAttributeAttribute>();
                if (attr != null)
                {
        ...
        private IXmlDataNode CreateElement(Type elementType)
        {
            ...
            var element = (IXmlDataNode)ctor.Invoke(new object[] { });
            return element;
        }

        public XmlElement SerializeToXmlElement(XmlDocument document, IXmlDataNode dataNode)
        {
            throw new NotImplementedException();
        }
    }
